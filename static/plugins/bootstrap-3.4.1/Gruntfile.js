...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      src: {
        files: '<%= jshint.functions.src %>',
        tasks: ['jshint:functions', 'exec:karma', 'concat']
      },
      test: {
  ...
  // Test task.
  var testSubtasks = [];
  // Skip functions tests if running a different subset of the test suite
  if (runSubset('core')) {
  ...
  grunt.registerTask('test-js', ['jshint:functions', 'jshint:test', 'jshint:grunt', 'jscs:functions', 'jscs:test', 'jscs:grunt', 'exec:karma']);

  // JS distribution task.
  grunt.registerTask('dist-js', ['concat', 'uglify:functions', 'commonjs']);

  // CSS distribution task.
  grunt.registerTask('dist-css', ['less:functions', 'less:theme', 'postcss:functions', 'postcss:theme', 'cssmin:functions', 'cssmin:theme']);
  ...
  grunt.registerTask('commonjs', 'Generate CommonJS entrypoint module in dist dir.', function () {
    var srcFiles = grunt.config.get('concat.functions.src');
